...
\begin{equation*}
    B_i = \{  b \in B_c \ | \ \forall i \in \llbracket 1, |B_c| \rrbracket, \exists ! j \in \llbracket 1, |A| \rrbracket, R_{a_j} \wedge t_i \ne \emptyset \wedge t_i \cap D = \emptyset \} %TODO
\end{equation*}
...
\subsection{Interception de tir}%TODO revoir cette partie.
