...
Une piste de résolution possible est l'utilisation de l'algorithme Branch and Reduce, défini dans l'article \og{} A Branch-and-Reduce Algorithm for Finding a Minimum Independent Dominating Set in Graphs \fg{}\footnote{\url{https://www.univ-orleans.fr/lifo/Members/Mathieu.Liedloff/publications/GL06.pdf}} par Serge \bsc{Gaspers} et Mathieu \bsc{Liedloff}.
